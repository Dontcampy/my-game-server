...
func DoConnectionBegin(connection iface.IConnection) {
	...
	connection.SetProperty("Name", "Sirius")
	connection.SetProperty("Home", "dont39.com")
	connection.SetProperty("Github", "github.com/dontcampy")
}
...
func DoConnectionLost(connection iface.IConnection) {
	...
	github, err := connection.GetProperty("Github")
	if err != nil {
		return
	}
